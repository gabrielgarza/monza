...
describe Monza::RenewalInfo do
  context 'pending renewal info' do
    ...
    it { expect(renewal_info.grace_period_purchase_date).to eq DateTime.parse('2013-08-01 07:00:00 Etc/GMT') }
    it { expect(renewal_info.grace_period_purchase_date_ms).to eq Time.zone.at("1375340400000".to_i / 1000) }
  end
end
