...
describe Monza::Receipt do
  context 'verification receipt' do
    ...
    it 'time zone' do
      ...
      expect(receipt.receipt_creation_date_ms).to eq DateTime.parse('2016-06-17 01:54:26 Etc/GMT')

      expect(receipt.request_date).to eq DateTime.parse('2016-06-17 17:34:41 Etc/GMT')
      expect(receipt.request_date_ms).to eq DateTime.parse('2016-06-17 17:34:41 Etc/GMT')

      expect(receipt.original_purchase_date).to eq DateTime.parse('2013-08-01 07:00:00 Etc/GMT')
      expect(receipt.original_purchase_date_ms).to eq DateTime.parse('2013-08-01 07:00:00 Etc/GMT')
    end
    ...
    it 'receipt' do
      ...
      expect(in_app.purchase_date_ms).to eq DateTime.parse('2016-06-17 01:32:28 Etc/GMT')

      expect(in_app.original_purchase_date).to eq DateTime.parse('2016-06-17 01:30:33 Etc/GMT')
      expect(in_app.original_purchase_date_ms).to eq DateTime.parse('2016-06-17 01:30:33 Etc/GMT')

      expect(in_app.expires_date).to eq DateTime.parse('2016-06-17 01:37:28 Etc/GMT')
      expect(in_app.expires_date_ms).to eq DateTime.parse('2016-06-17 01:37:28 Etc/GMT')
    end
  end
end
